...
La NUCLEO envía cada determinado tiempo los valores adc0, adc1, temperatura, input0 e input1. Se definio un intervalo de 3 segundos para el envio.
Además, envía todos los datos cuando hay un cambio en alguna de sus entradas.
